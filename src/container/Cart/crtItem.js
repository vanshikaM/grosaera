...
import { updateCartQuantity, removeFromCart } from '../../store/cartAction';
class crtItem extends Component {
    constructor(props) {
        super(props);
        this.state = {
  ...
  render() {
      ...
      return (
          <div className="row">
              <div className="col-xs-2"><img className="img-responsive" src={item.product.item} />
              </div>
...
export default connect(null, mapDispatchToProps)(crtItem);